...
const DecoratorMenu = () => {
    return (
        <nav className='flex flex-col justify-center items-center'>
            ...
            <NavLink to='/dashboard/earn-summary' className='flex cursor-pointer w-full items-center px-4 py-2  text-gray-600 hover:bg-gray-300   hover:text-gray-700 transition-colors duration-300 transform '>
                <MdSummarize className='w-5 h-5' />
                <span className='mx-4 font-medium'>Earning Summary</span>
            </NavLink>
            <NavLink to='/dashboard/assign-project' className='flex cursor-pointer w-full items-center px-4 py-2  text-gray-600 hover:bg-gray-300   hover:text-gray-700 transition-colors duration-300 transform '>
