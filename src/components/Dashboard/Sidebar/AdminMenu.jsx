...
const AdminMenu = () => {
    return (
        <nav className='flex flex-col justify-center items-center'>
            ...
            <NavLink to='/dashboard/create-package' className='flex cursor-pointer w-full items-center px-4 py-2  text-gray-600 hover:bg-gray-300   hover:text-gray-700 transition-colors duration-300 transform '>
                <GrServices className='w-5 h-5' />
